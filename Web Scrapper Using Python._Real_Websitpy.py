...
keywords_allowed={"exam",
    "mid",
    "final",
    "fst"}
keywords_notallowed={"seat plan",
    "set b"}
...
for n in notices:
    ...
    # allowed=any(words in title_text.lower() for words in keywords_allowed)
    # forbidden_word=any(words in title_text.lower() for words in keywords_notallowed)
